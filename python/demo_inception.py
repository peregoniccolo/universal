...
if __name__ == "__main__":
    ...
    with tf.device(device):
        ...
        str_label_original = labels[int(label_original[0]) - 1].split(",")[0]
        print(f"Original: {str_label_original}")
        ...
        str_label_perturbed = labels[int(label_perturbed[0]) - 1].split(",")[0]
        print(f"Perturbed: {str_label_perturbed}")
